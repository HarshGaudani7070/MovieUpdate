...
import com.example.movieupdate.databinding.FragmentUpcomingMovieBinding
...
class UpcomingMovie : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentUpcomingMovieBinding.inflate(layoutInflater)
    ...
    private fun callApi(page: Int) {
        ...
        api.getUpcoming(this.page,"bearer ${ApiClient.Token}").enqueue(object :
            Callback<MovieModal> {
